<section class="mod-banner cus-container items-center mt-[-50px] min-h-[857px]">
    <div class="bg-img w-full relative ">
        <img class="w-full md:h-[769px]" src="<?php echo App::getBanner()['Banner']; ?>" alt="<?php echo App::getBanner()['alt']; ?>">
    </div>
